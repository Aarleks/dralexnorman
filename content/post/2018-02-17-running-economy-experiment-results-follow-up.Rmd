...
In that 35-day range I ran 36 times, with a minimum distance of 656m and a maximum of 6.7km. I covered a distance of 107.25km in a total time of 727.6 minutes (just over 12hrs), for an average pace of 6:47/km. One run was really a jog/walk with the kids on Christmas Day. But the real interest is in the running economy over that time. Using the formular from the same post above, here is a scatter plot of my running economy with a loess-smoothed conditional mean:
